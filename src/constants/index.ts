...
export const extraServices:ISaleCard[] =[
  { id:1, srcImg:'@/assets/ExtraImg1.png',name:"Source from Industry Hubs" , icon: '<HiSearch />' },
  { id:2, srcImg:'@/assets/ExtraImg1.png',name:"Customize Your Products" , icon:'<HiSearch />' },
  { id:3, srcImg:'@/assets/ExtraImg1.png',name:"Fast, reliable shipping by ocean or air" , icon:'<HiSearch />' },
  { id:4, srcImg:'@/assets/ExtraImg1.png',name:"Product monitoring and inspection" , icon:'<HiSearch />' },
]
